<?php
	...
	@$csql = "select count(*) as c from post where sta = 1 {$and}";
	...
	//查询用户表所有信息
	@$sql = "select * from post where del = 1 {$and} {$limit}";
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
			 ...
			 <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
				...
				<td align="center" valign="middle" class="borderbottom">
					...
					<a href="../post/del.php?cid=<?php echo $uinfo['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
					<span class="gray">&nbsp;|&nbsp;</span>
					<a href="../del/huishouzhan.php?id=<?php echo $uinfo['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add">恢复帖子</a>
					<span class="gray">&nbsp;|&nbsp;</span>
		...
		<table  align="right">
		  <tr class="fenye">
			<td align="" valign="top" class="fenye"><?php echo $count ;?>条数据 <?php echo $page.'/'. $cpage ;?>页&nbsp;&nbsp;
				<a href="./del_list.php?page=1<?php echo $url;?>" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp
				<a href="./del_list.php?page=<?php echo $prev.$url;?>"  target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
				<a href ="./del_list.php?page=<?php echo $next.$url;?>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
				<a href= "./del_list.php?page=<?php echo $cpage.$url;?>" target="mainFrame" onFocus="this.blur()">尾页</a>
			</td>
		  </tr>
		</table>
	</body>
