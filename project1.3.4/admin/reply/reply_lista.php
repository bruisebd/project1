<?php
	...
	@$csql = "select count(*) as c from post  {$where}";
	...
	//查询用户表所有信息
	@$sql = "select id,cid,uid,title,content,add_time from post  {$where} {$limit}";
	$res = mysql_query($sql);
		...
		<form method = 'post' action  = './del.php'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
			  ...
			  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
				...
				<td align="center" valign="middle" class="borderright borderbottom"><?php echo $uinfo['uid']?></td>
				<td align="center" valign="middle" class="borderright borderbottom"><?php echo $uinfo['cid']?></td>
