<?php
	...
	if(!empty($_GET['cate_name'])){
		$where = "where pname like '%{$_GET['cate_name']}%'";
		$url = "&user={$_GET['user']}";
	}
	...
	@$csql = "select count(*) as c from part  {$where}";
	...
	//查询用户表所有信息
	@$sql = "select id,pname,addtime from part  {$where} {$limit}";
	$res = mysql_query($sql);
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
			<tr>
			 <td width="90%" align="left" valign="middle">
				 <form method="get" action="part_list.php">
					 <span>分区名：</span>
			  ...
			  <a href="./add_part.php" target="mainFrame" onFocus="this.blur()" class="add">新增分区</a></td>
			</tr>
		</table>
		</td>
	  </tr>
	  <tr>
		...
		<form method = 'post' action  = './del.php'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
				<tr>
					<th align="center"  class="borderright">分区ID</th>
					<th align="center" valign="middle" class="borderright">分区名</th>
			  ...
			  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
				...
				<a href="./modify_part.php?pid=<?php echo $uinfo['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
		...
		<table  align="right">
		  <tr class="fenye">
			<td align="" valign="top" class="fenye"><?php echo $count ;?>条数据 <?php echo $page.'/'. $cpage ;?>页&nbsp;&nbsp;
				<a href="./part_list.php?page=1<?php echo $url;?>" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp
				<a href="./part_list.php?page=<?php echo $prev.$url;?>"  target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
				<a href ="./part_list.php?page=<?php echo $next.$url;?>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
				<a href= "./part_list.php?page=<?php echo $cpage.$url;?>" target="mainFrame" onFocus="this.blur()">尾页</a>
			</td>
		  </tr>
		</table>
	</body>
